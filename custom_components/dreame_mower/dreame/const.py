...
PROPERTY_TO_NAME: Final = {
    ...
    DreameMowerProperty.RESUME_CLEANING.name: ["resume_cleaning", "Resume Mowing"],
    DreameMowerProperty.REMOTE_CONTROL.name: ["remote_control", "Remote Control"],
    DreameMowerProperty.CLEANING_PAUSED.name: ["cleaning_paused", "Mowing Paused"],
    ...
    DreameMowerProperty.CLEANING_CANCEL.name: ["cleaning_cancel", "Mowing Cancel"],
    ...
    DreameMowerProperty.CLEANING_COUNT.name: ["cleaning_count", "Mowing Sessions"],
